...
// en agosto), solo `cots`/`ocs` (los "totalOrigen") respetan el filtro. Ver
// el comentario más largo junto a `ocsConFactura` en el componente Dashboard.
function KpiContrasteCard({ cots, ocs, ocsTodas, factsTodas, otsTodas }) {
  const montoCot = (c) => Number(c.total) || 0;

  // "Enviadas": todas las cotizaciones no anuladas (cualquier otro estado).
  // "Aceptadas": de esas, las que ya generaron al menos una Orden de
  // Trabajo — el cliente aprobó y el trabajo arrancó.
